...
class _ChatList extends ViewModelWidget<ChatViewModel> {
  ...
  Widget build(BuildContext context, ChatViewModel model) {
    return StreamBuilder<DocumentSnapshot>(
        stream: FireChatService.getChats(),
...
class _ChatTile extends ViewModelWidget<ChatViewModel> {
  ...
  Widget build(BuildContext context, ChatViewModel model) {
    return Column(
      ...
      crossAxisAlignment: message.isCustomer ? CrossAxisAlignment.end : CrossAxisAlignment.start,
      children: [
            ...
            Flexible(
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: message.isCustomer ? BrandColors.brandColor : BrandColors.light,
                  borderRadius: BorderRadius.only(
                    topLeft: Radius.circular(message.isCustomer ? 12.0 : 0.0),
                    topRight: Radius.circular(12.0),
                    bottomLeft: Radius.circular(12.0),
                    bottomRight: Radius.circular(message.isCustomer ? 0.0 : 12.0),
                  ),
                ),
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Flexible(child: BrandTexts.commonText(text: "${message.message}", fontSize: 14.0, maxLines: 8)),
                        SizedBox(width: 8.0),
                        BrandTexts.caption(
                            text:
    ...
    return Column(
      ...
      children: [
        StreamBuilder<DocumentSnapshot>(
            stream: FireChatService.getIsTyping(),
            builder: (context, snapshot) {
              //isTyping
